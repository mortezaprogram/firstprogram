...
buttom_1=ttk.Button(frame,text='Click',command=set_entry)
buttom_1.grid(column=3,row=1,sticky=(W,E))
buttom_1['state']='disabled'
buttom_1['state']='enabled'
entry_1_txt.set(buttom_1.instate(['disabled']))
chk_but_1_txt=StringVar()
chk_but_1=ttk.Checkbutton(frame,text='Feelings',command=chk_but_changed,variable=chk_but_1_txt,onvalue='Happy',offvalue='Sad')
