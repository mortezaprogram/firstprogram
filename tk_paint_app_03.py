...
class PaintApp:
    ...
    def line_draw(self, event=None):
        if None not in (self.x1_line_pt, self.y1_line_pt, self.x2_line_pt, self.y2_line_pt):
            ...
            self.draw.line([(self.x1_line_pt, self.y1_line_pt),(self.x2_line_pt, self.y2_line_pt)],fill=self.stroke_color.get(),width=self.stroke_size.get())
    def arc_draw(self, event=None):
        if None not in (self.x1_line_pt, self.y1_line_pt, self.x2_line_pt, self.y2_line_pt):
            coords = self.x1_line_pt, self.y1_line_pt, self.x2_line_pt, self.y2_line_pt
            event.widget.create_arc(coords, start=0, extent=150,style=ARC, fill=self.stroke_color.get())
            self.draw.arc([(self.x1_line_pt, self.y1_line_pt),(self.x2_line_pt, self.y2_line_pt)],fill=self.stroke_color.get())

    def oval_draw(self, event=None):
        if None not in (self.x1_line_pt, self.y1_line_pt, self.x2_line_pt, self.y2_line_pt):
            event.widget.create_oval(self.x1_line_pt, self.y1_line_pt, self.x2_line_pt, self.y2_line_pt,fill=self.fill_color.get(),outline=self.stroke_color.get(),width=self.stroke_size.get())
            self.draw.ellipse([(self.x1_line_pt, self.y1_line_pt),(self.x2_line_pt, self.y2_line_pt)],fill=self.fill_color.get(),outline=self.stroke_color.get())

    def rectangle_draw(self, event=None):
        if None not in (self.x1_line_pt, self.y1_line_pt, self.x2_line_pt, self.y2_line_pt):
            event.widget.create_rectangle(self.x1_line_pt, self.y1_line_pt,self.x2_line_pt, self.y2_line_pt,fill=self.fill_color.get(),outline=self.stroke_color.get(),width=self.stroke_size.get())
            self.draw.rectangle([(self.x1_line_pt, self.y1_line_pt),(self.x2_line_pt, self.y2_line_pt),], fill=self.fill_color.get(),outline=self.stroke_color.get())
    def text_draw(self, event=None):
        if None not in (self.x1_line_pt, self.y1_line_pt):
            ...
            if user_text is not None:
                event.widget.create_text(self.x1_line_pt, self.y1_line_pt,fill=self.fill_color.get(),font=text_font,text=user_text)
